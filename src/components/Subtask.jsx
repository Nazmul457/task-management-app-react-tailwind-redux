...
function Subtask({ index, taskIndex, colIndex }) {
  ...
  return (
    <div className=" w-full flex hover:bg-[#635fc740] dark:hover:bg-[#635fc740] rounded-md relative items-center justify-start dark:bg-[#20212c] p-3 gap-4 ">
      <input type="checkbox" className=" w-4 h-4 accent-[#635fc7] cursor-pointer " 
      checked={checked}
      onChange={onChange}
      />
      <p
      className={checked ? ' line-through opacity-30 ' : undefined} 
      >
        {subtask.title}
      </p>
    </div>
