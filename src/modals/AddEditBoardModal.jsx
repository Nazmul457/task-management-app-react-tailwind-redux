...
function AddEditBoardModal({ setBoardModalOpen, type }) {
  ...
  return (
    ...
    >
      {/* Modal Section */}
      <div className=" scrollbar-hide overflow-y-scroll max-h-[95vh] bg-white dark:bg-[#2b2c37] text-black dark:text-white font-bold shadow-[#364e7e] max-w-md mx-auto w-full px-8 py-8 rounded-xl ">
